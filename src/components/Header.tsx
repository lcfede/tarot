...
export default function Header({ cur, pct, chatOpen, showPulse, onToggleNav, onToggleChat, onLogout }: Props) {
    ...
    <div style={{ padding: "10px 18px", borderBottom: "1px solid rgba(201,168,76,0.15)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0, background: "rgba(8,6,18,0.6)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div className="header-lesson-title">
          <div style={{ fontSize: 9, color: "rgba(201,168,76,0.45)", letterSpacing: 2, textTransform: "uppercase" }}>{cm ? cm.i + " " + cm.t : ""}</div>
        ...
        <div className="header-pct" style={{ display: "none", flexDirection: "column", gap: 3 }}>
          <div style={{ fontSize: 9, color: "rgba(201,168,76,0.5)", letterSpacing: 2, textTransform: "uppercase" }}>Progreso</div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <button
          ...
          style={{
            ...
            color: chatOpen ? "#c9a84c" : "rgba(201,168,76,0.5)",
        ...
        >
          ...
          {showPulse && (
            <span style={{ position: "absolute", top: -2, right: -2, width: 7, height: 7, borderRadius: "50%", background: "#c9a84c", animation: "pulse 2s infinite" }} />
          )}
        </button>
        <button
          onClick={onLogout}
