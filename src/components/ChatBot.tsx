  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div ref={ref} style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", gap: 8, marginBottom: 12, paddingRight: 4 }}>
        ...
        {ld && (
          <div style={{ padding: "10px 14px", borderRadius: 4, background: "rgba(201,168,76,0.03)", border: "1px solid rgba(201,168,76,0.12)", color: "rgba(201,168,76,0.75)", fontSize: 12, fontFamily: "Georgia,serif", fontStyle: "italic" }}>
            Consultando...
          </div>
        )}
      </div>
